<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cargo.aspx.cs" Inherits="WebChatBot.CargoCustomerName" %>
...
<head runat="server">
    ...
    <title>Tìm kiếm mở rộng cho nghiệp vụ hàng hóa</title>
    <!-- Main CSS-->
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <asp:GridView ID="gvListData" runat="server"   AutoGenerateColumns="False" CssClass="table table-hover table-bordered" OnRowDataBound="gvListData_RowDataBound"  DataKeyNames="TT" PageSize="10"  >
                            <Columns>
                                <asp:TemplateField HeaderText="TT" HeaderStyle-Width="1%" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                    </ItemTemplate>
                                </asp:TemplateField>
